...
namespace FractalViewer {
	...
	ImGuiView::ImGuiView(void* window) {

		this->window = window;
	}

	void ImGuiView::OnInit() {
	...
	void ImGuiView::OnUpdate(float dt) {

	}

	void ImGuiView::OnGuiRender(float dt) {

	}

	void ImGuiView::OnEvent(const Event& e) {

	}

	void ImGuiView::InitTheme() {
